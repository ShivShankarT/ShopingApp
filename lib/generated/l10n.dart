...
class S {
  ...
  /// `Select extras to add them on the products`
  ...
  /// `Long press on the product to add extra`
  ...
  /// `You can discover stores around you and choose your best products after few minutes we packed and delivered to you`
  String get you_can_discover_restaurant {
    return Intl.message(
      'You can discover stores around you and choose your best products after few minutes we packed and delivered to you',
      name: 'you_can_discover_restaurant',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Reset your cart and order products form this store`
  ...
  /// `Long press to edit item, swipe to delete it`
  ...
  /// `Street/Apt Name, City, Pincode, State`
  ...
  /// `Payment cart updated successfully`
  ...
  /// `Store near to your current location`
  ...
  /// `This product has been successfully add to cart`
  ...
  /// `Click to pay with your Debit Card`
  ...
  /// `This product has been successfully add to favorite`
  ...
  /// `Delivery address outside the delivery range of this store.`
